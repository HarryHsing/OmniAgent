...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            import wandb
            settings_args = {
                "disable_code": config["wandb"]["disable_code"],
                "_disable_stats": config["wandb"]["_disable_stats"],
                "console": config["wandb"]["console"],
            }

            wandb.init(project=project_name, name=experiment_name, config=config, settings=wandb.Settings(**settings_args))
