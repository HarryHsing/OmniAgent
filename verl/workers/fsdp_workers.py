...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        if not torch.distributed.is_initialized():
            ...
            # print(f"DEBUG - is_cuda_available: {is_cuda_available}")
        ...
        if self._is_actor:
            ...
            # zhenghao edit
            # self.config.actor.ppo_mini_batch_size *= self.config.env.rollout.n
            ...
            print("FINAL ppo_mini_batch_size: ", self.config.actor.ppo_mini_batch_size)
    ...
    def _build_model_optimizer(
        ...
        with init_context(), warnings.catch_warnings():
            ...
            apply_monkey_patch(
                model=actual_executed_module, # actor_module for verl-agent
        ...
        #  zhenghao omni add
        auto_wrap_policy = get_fsdp_wrap_policy(module=to_wrap_actor_module, config=fsdp_config.get("wrap_policy", None), is_lora=self.config.model.get('lora_rank', 0) > 0)
    ...
    def update_actor(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            # tmp_len = len(data)
            # print(f"ulysses_sharding_manager.preprocess_data len(data) = {tmp_len}")
            # perform training
    ...
    def generate_sequences(self, prompts: DataProto):
        ...
        # # "eos_token_id": 151645, # for omni
        # # "pad_token_id": 151643, # for omni
...
class CriticWorker(Worker):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        with init_context(), warnings.catch_warnings():
            ...
            apply_monkey_patch(
                model=actual_executed_module, # critic_module for verl-agent
                use_remove_padding=use_remove_padding,
                ulysses_sp_size=self.ulysses_sequence_parallel_size,
            )
