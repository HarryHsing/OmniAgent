...
class TrajectoryCollector:
    ...
    #    - Throughput Matching: By setting chunk size to a multiple of GPU count via
    #      `MICRO_RATIO`, each worker is fully utilized in every inference wave.
    #
    ...
    def pool_async_multi_turn_loop(
        ...
        ratio = int(float(os.getenv("MICRO_RATIO", "1")))                 # e.g. "1", "2", "4"
