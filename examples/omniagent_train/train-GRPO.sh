...
train_data_size=32
val_data_size=8                                                        #   val_data_size * N should be MICRO_RATIO times total GPU count
...
export RETRY_ON_FORMAT_ERROR=False  # Enable retry and trajectory filtering mode
...
entropy_weight=false             # enable entropy weight; set to true to enable

PROJECT_NAME=verl_omni
MODEL_NAME=OmniAgent_SFT
MODE=OmniAgent
